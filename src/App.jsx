  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.wrapper}>
        <h1 style={{color:'#eeeeee'}}>Movie List by OMDBAPI</h1>
        <Search
        ...
        {movieList.length === 0 && !isMovieListLoading && (
          <p className={`${styles['no-movie']}`} style={{color:'#eeeeee'}}>no data in search</p>
        )}
        <MovieList
          movieList={movieList}
        ...
        />
        {isFetching && (
          <p className={`${styles.fetch}`} style={{color:'#eeeeee'}}>fetching ore movie list...</p>
        )}
      </section>
    </div>
  );
